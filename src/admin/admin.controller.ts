import { Controller, Delete, Get, HttpException, HttpStatus, Inject, Param, Post, UseGuards } from '@nestjs/common'
...
export class AdminController {
  ...
  async delete (@Param('id') id: string) {
    ...
    this.adminService.deleteByIds(ids).catch((e) => { this.logger.logException(e) })
  }
