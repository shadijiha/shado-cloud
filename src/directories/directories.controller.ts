...
export class DirectoriesController {
  ...
  public zip (@AuthUser() userId: number, @Body() body: NewDirRequest): OperationStatusResponse {
    try {
      this.directoriesService.zip(userId, body.name).catch((e) => { this.logger.logException(e) })
      return {
  ...
  public unzip (@AuthUser() userId: number, @Body() body: NewDirRequest) {
    try {
      this.directoriesService.unzip(userId, body.name).catch((e) => { this.logger.logException(e) })
